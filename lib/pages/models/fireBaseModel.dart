...
class FirebaseUserModule {
  ...
  static Future<ResponseModel> createUser(
    ...
    try {
      ...
      UserCredential userCredential = await (_auth..tenantId = tenantId)
  ...
  static Future<ResponseModel> login(
      ...
      String email, String password, String? tenantsId) async {

    try {

      UserCredential userCredential =

          await (auth..tenantId = tenantsId).signInWithEmailAndPassword(
