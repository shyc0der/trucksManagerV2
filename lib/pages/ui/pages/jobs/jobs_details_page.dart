...
import 'package:truck_manager/pages/ui/widgets/order_items_widget.dart';
import 'package:truck_manager/pages/ui/widgets/update_state_widget.dart';
            ...
            Padding(
              ...
              child: SingleChildScrollView(
                  ...
                  child: StreamBuilder<List<ExpenseModel>>(
                      stream: _expenseModule.fetchByJobExpenses(widget.job.id!,
                          userModule.currentUser.value.tenantId!, userModule.currentUser.value),
                      builder: (context, snapshot) {
