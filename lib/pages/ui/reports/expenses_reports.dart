...
class ExpensesReport extends ReportGeneratorModule {
 ...
 final UserModule userModule = Get.find<UserModule>();
  ...
  Future getExpenses() async {
    var _exes = (await _expenseModule
        .fetchAllWhereDateRangeExpenses(dateRange, userModule.currentUser.value.tenantId!)
        .first);
    // filter
    ...
    for (var _exp in _exes) {
      // get driver name
      final _user = await userModule.getUserById(_exp.userId ?? 'null');
