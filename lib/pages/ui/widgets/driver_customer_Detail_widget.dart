...
import 'package:truck_manager/pages/ui/widgets/custom_dropdown.dart';
...
final UserModule userModule = Get.find<UserModule>();
  ...
  void initState() {
    ...
    _truckModule.fetchTrucksReges(userModule.currentUser.value.tenantId!).then((value) {
      setState(() {
        _trucks = value;
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.of(context).pop([
                    hasDriver ? _userName! : "c9AP9R06ugY54uHMmhscoTarpix2",
                    hasDriver ? _truck! : "EVwLiKI3Bazd6vLakBWt",
                    lpoController.text
                  ]);
                },
